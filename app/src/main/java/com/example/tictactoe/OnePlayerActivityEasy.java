...
public class OnePlayerActivityEasy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.one_player_easy_activity);
            ...
            for (int j = 0; j < COLS; j++) {
                ...
                board[i][j].setOnClickListener(v -> {
                    ...
                    if (keepPlaying) {
                        ...
                        handler.postDelayed(this::bestMove, 400);
                    }
                });
            }
        }
    ...
    public void aiMakeMove(TextView position) {
        if (oPlayer.getTurn()) {
            ...
            MediaPlayer ring = MediaPlayer.create(this, R.raw.o);
            ring.start();
    ...
    public void humanMakeMove(TextView position) {
        if (xPlayer.getTurn()) {
            ...
            MediaPlayer ring = MediaPlayer.create(this, R.raw.x);
            ring.start();
    ...
    public void updateLabels() {
        if (isXWon) {
            ...
            MediaPlayer ring = MediaPlayer.create(this, R.raw.win);
            ring.start();
    ...
    public void initComponents() {
        ...
        ImageView nextLevel = findViewById(R.id.nxt);
        nextLevel.setOnClickListener(v -> {
            Intent myIntent = new Intent(getApplicationContext(), OnePlayerActivityExpert.class);
            startActivity(myIntent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        });

        menuButton.setOnClickListener(view -> {
            MediaPlayer ring = MediaPlayer.create(this, R.raw.button);
            ring.start();
    ...
    public void bestMove() {
        ...
        for (int i = 0; i < ROWS; i++)
            for (int j = 0; j < COLS; j++)
            {
                if(!board[i][j].getText().toString().equals("X") && !board[i][j].getText().toString().equals("O") )
                {
                    List<Integer> pair = new ArrayList<>();
                    pair.add(i); pair.add(j);
                    availableSlots.add(pair);
                }
            }
        int random = (int) (Math.random() * availableSlots.size());
        bestPosition = board[availableSlots.get(random).get(0)][availableSlots.get(random).get(1)];
